...
def fetch_current(movie_id):
    ...
    s = 'https://api.themoviedb.org/3/movie/{}?api_key=8265bd1679663a7ea12ac168da84d2e8&language=en-US'.format(movie_id[0])
...
if st.button('Recommend'):
    ...
    current_movie_id = movies[movies['title'] == selected_movie].movie_id
